...
function Header({ sideBarCollapsed, onToggleSidebar }) {
  ...
  return (
    <div className="bg-white backdrop-blur-xl border-b border-slate-200/50 dark:border-slate-700/50 px-6 py-4 relative z-40">
      <div className="flex items-center justify-between">
        {/* Left Section */}
        <div className="flex items-center space-x-4">
          <button
            className="p-2 rounded-lg text-slate-600 dark:text-[#0AB0EE] hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors"
