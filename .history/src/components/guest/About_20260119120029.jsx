      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-600 text-lg">
            Umubano Academy (UA) is a private school located in Kigali City, Kicukiro District, Kanombe Sector, Kabeza Cell, in Nyarurembo Village. It opened its doors in 2013 with two sections; nursery and primary. In 2018 it started a third section which is Lower Secondary. The school was established by A Partner in Education (APIE), an international NGO from the UK, and it is governed by Umubano Organisation, a local NGO based in Kigali. UA follows the Rwandan Competence-Based Curriculum and at the same time delivers this utilising international best practices and approaches. 
          </p>
        </motion.div>
        ...
        >
          ...
          >
            ...
            <p className="text-gray-600">
              To empower all students to become peace-loving, creative and resilient leaders who strive for excellence in order to create a brighter future for themselves, their country and the world at large.
            </p>
          </motion.div>
...
●   Promote high expectations of all learners’ academic progress and attainment
●   Support all learners to become responsible and well-behaved through the consistent use of positive behaviour management strategies and the teaching of Social and Emotional Learning skills
●   Foster inclusive practices for all learners
●   Provide vibrant co-curricular provisions which maximise all learners skills, talents and aspirations and which promote creativity and teamwork
