    ...
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
          ...
          {newsList.map((news, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <a
                  href="#"
                  className="text-[#0AB0EE] font-semibold hover:text-blue-700 transition"
                >
                  Read More →
                </a>
              </div>
        ...
        <div className="text-center mt-14">
          <a
            href="/news"
            className="inline-block bg-blue-900 text-white px-8 py-4 rounded-xl font-semibold hover:bg-blue-800 transition shadow-lg"
          >
            View All News
          </a>
        </div>
