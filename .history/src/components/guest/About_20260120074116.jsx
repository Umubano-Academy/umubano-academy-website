    ...
    <section className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="bg-white rounded-3xl shadow-lg p-12 mb-24" id="values"
        >
...
>
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
    {[
      { name: "Parent of Nursery", text: "Umubano Academy gave my child confidence and love for learning." },
      { name: "Parent of Primary", text: "Teachers are caring, professional and focused on each child." },
      { name: "Parent of Lower Secondary", text: "My child improved both academically and socially." },
    ].map((t, i) => (
...
>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
    {[
      { name: "Alumni 2018", text: "Umubano Academy shaped my discipline and leadership skills." },
      { name: "Alumni 2020", text: "I am proud to say I started my journey at Umubano Academy." },
    ].map((a, i) => (
