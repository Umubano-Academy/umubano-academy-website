      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          {steps.map((step, index) => (
            ...
            >
              <div className="w-16 h-16 mx-auto mb-6 bg-blue-900 text-yellow-400 flex items-center justify-center rounded-2xl">
                {step.icon}
              </div>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="bg-blue-900 rounded-3xl p-10 md:p-14 text-white grid grid-cols-1 md:grid-cols-2 gap-10"
        >
          <div>
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                href="/apply"
                className="border border-white px-8 py-4 rounded-xl font-semibold hover:bg-white hover:text-blue-900 transition text-center"
              >
                Apply Now
              </a>
            </div>
