...
function WhyCooseUs() {
  return (
    ...
    <p className="text-gray-900 max-w-3xl mx-auto text-lg"> We focus on academic excellence, strong moral values, personalized support, and innovative learning methods to help each student achieve their full potential. </p> </motion.div>
  )
}
