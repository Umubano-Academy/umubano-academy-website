...
import staff1 from "../../assets/logo2.png"
import staff2 from "../../assets/logo2.png"
import staff3 from "../../assets/logo2.png"

function About() {
  const staff = [
    { name: "Alice Uwimana", role: "Principal", img: staff1 },
    { name: "John Mukasa", role: "Head Teacher", img: staff2 },
    { name: "Grace Niyonsaba", role: "Senior Teacher", img: staff3 },
  ]
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-600 text-lg">
            Umubano Academy was founded with the goal of providing quality education
            rooted in strong moral values. Over the years, we have nurtured students
            to excel academically, socially, and morally, shaping future leaders of
        ...
        >
          ...
          >
            <div className="w-16 h-16 bg-[#FFDE59] text-yellow-400 flex items-center justify-center rounded-xl mb-4">
              <BookOpen />
            </div>
          ...
          <motion.div
            ...
            className="bg-white rounded-3xl shadow-lg p-10 flex flex-col items-center text-center hover:shadow-2xl transition"
          >
            <div className="w-16 h-16 bg-blue-900 text-yellow-400 flex items-center justify-center rounded-xl mb-4">
              <Users />
            </div>
            <h4 className="text-2xl font-bold text-blue-900 mb-3">Our Mission</h4>
            <p className="text-gray-600">
              To provide a safe, supportive, and engaging learning environment
              that empowers students to achieve academic excellence and develop
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="bg-blue-900 text-white rounded-3xl p-12 text-center"
        >
