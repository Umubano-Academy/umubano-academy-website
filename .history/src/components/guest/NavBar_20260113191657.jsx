...
const navLinks = [
  ...
  { name: "Academics", type: "route", path: "/academics" },
  { name: "Admissions", type: "route", path: "/admissions" },
  { name: "News", type: "id", path: "news" },
  { name: "Events", type: "id", path: "events" },
      ...
      <div className="hidden md:flex justify-between items-center px-8 py-2 bg-[#FFDE59]  text-sm">
        <div className="flex items-center gap-4">
          <span className="flex items-center gap-1 text-xl text-black font-bold">
            <Phone size={18} className="text-[#7ED956] text-2xl" /> +250 782029655
          </span>
          <span className="flex text-xl items-center gap-1  text-black font-bold">
            <Mail size={18} className="text-[#7ED956] text-2xl" /> info@umubanoacademy.rw
          </span>
        </div>
