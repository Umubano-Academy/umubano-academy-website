      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              href="/admission"
              className="bg-[#7ED956] text-blue-900 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-yellow-300 transition shadow-lg"
            >
            ...
            <a
              href="/academic"
              className="border border-white/40 px-8 py-4 rounded-xl font-semibold text-lg text-ble bg-[#D9D9D9] hover:bg-[#0AB0EE] hover:text-blue-900 transition"
            >
              Explore Academics
            </a>
          </div>
