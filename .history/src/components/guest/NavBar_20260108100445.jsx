...
function NavBar() {
  ...
  return (
    <>
      {/* Top Info Bar */}
      <div className="hidden md:flex justify-between items-center px-8 py-2 bg-blue-900 text-white text-sm">
        ...
        <span className="font-medium text-xl">Excellence in Education</span>
      </div>
