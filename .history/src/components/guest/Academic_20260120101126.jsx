      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <h2 className="text-4xl font-bold text-[#0AB0EE] mb-4">
            Academic Calendar and Student Add-ons
          </h2>
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          <h1 className="text-4xl font-bold text-[#0AB0EE] mb-4">
            Education at Umubano Academy
          </h1>
          <p className="text-gray-700 text-lg">
            At Umubano Academy, we provide a holistic, student-centered learning
            experience that develops academic excellence, character, and
