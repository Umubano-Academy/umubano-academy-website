              ...
              {navLinks.map((link) =>
                link.type === "route" ? (
                  ...
                  <div key={link.name} className="relative group">
                    ...
                    {/* Dropdown menu */}
                    <div className="absolute top-full left-0 mt-2 w-48 bg-white shadow-lg rounded-xl opacity-0 group-hover:opacity-50 invisible group-hover:visible transition-opacity z-50">
