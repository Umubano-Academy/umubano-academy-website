...
import nurseImg from "../../assets/gallery/image_6.jpg";
  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-20 space-y-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {[
          { title: "Nursery", img: "/images/nursery.jpg", link: "/academic" },
          { title: "Primary", img: "/images/primary.jpg", link: "/academic" },
          { title: "Lower Secondary", img: "/images/secondary.jpg", link: "/academic" },
        ].map((item, i) => (
          <Link
            key={i}
            to={item.link}
