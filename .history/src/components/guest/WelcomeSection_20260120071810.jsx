  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-20 space-y-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {[
          { title: "Nursery", img: "/images/nursery.jpg", link: "/education#nursery" },
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-6">
          ...
          <div className="flex gap-6 mt-4">
            <Link to="/about" className="flex items-center gap-2 text-blue-800 hover:text-[#0AB0EE]">
              <Info className="w-5 h-5" />
              About Us
            </Link>

            <Link to="/values" className="flex items-center gap-2 text-blue-800 hover:text-[#0AB0EE]">
