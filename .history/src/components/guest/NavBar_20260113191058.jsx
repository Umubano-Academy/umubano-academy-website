...
function NavBar() {
  ...
  return (
    <>
      {/* Top Info Bar */}
      <div className="hidden md:flex justify-between items-center px-8 py-2 bg-[#FFDE59] text-[#7ED956] text-sm">
        <div className="flex items-center gap-4">
          <span className="flex items-center gap-1 text-xl text-gray-300 font-medium">
            <Phone size={18} /> +250 782029655
          </span>
          <span className="flex text-xl items-center gap-1  text-[#7ED956] font-medium">
            <Mail size={18} /> info@umubanoacademy.rw
          </span>
        </div>
        <span className=" text-xl  text-[#7ED956] font-medium">Excellence in Education</span>
      </div>
