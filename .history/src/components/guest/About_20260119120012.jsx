        ...
        >
          ...
          >
            ...
            <p className="text-gray-600">
              ...
              resilient leaders who strive for excellence in order to create a
              brighter future for themselves, their country and the world at
              large.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-600">
              ...
              ● Promote high expectations of all learners’ academic progress and
              attainment ● Support all learners to become responsible and
              well-behaved through the consistent use of positive behaviour
              management strategies and the teaching of Social and Emotional
              Learning skills ● Foster inclusive practices for all learners ●
              Provide vibrant co-curricular provisions which maximise all
              learners skills, talents and aspirations and which promote
