...
function Contact() {
  return (
    <section id="" className="py-28 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-24">
          ...
          >
            <h3 className="text-2xl font-bold text-[#0AB0EE] mb-2">
              Send Us a Message
            </h3>
            ...
            <button
              type="submit"
              className="flex items-center justify-center gap-3 w-full bg-[#7ED956] text-white py-4 rounded-xl font-semibold text-lg hover:bg-blue-800 transition shadow-xl"
            >
              <Send size={20} />
              Send Message
            </button>
