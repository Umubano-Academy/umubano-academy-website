      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-6">
            ...
            <span className="text-yellow-400">Excellence in Education</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              href="/admission"
              className="bg-yellow-400 text-blue-900 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-yellow-300 transition shadow-lg"
            >
            ...
            <a
              href="/academic"
              className="border border-white/40 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-white hover:text-blue-900 transition"
            >
              Explore Academics
            </a>
          </div>
