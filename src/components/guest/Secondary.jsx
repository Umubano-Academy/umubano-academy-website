...
import secondaryHeader from "../../assets/gallery/image6.JPG";
    ...
    <section className="bg-gray-50">
      ...
      <div className="relative w-full h-72 md:h-[420px]">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-black/60 to-black/30 flex flex-col justify-center items-center text-center text-white">
          ...
          <p className="text-lg md:text-xl">Ages 13 – 15</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 space-y-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-center">
          ...
          <div className="lg:col-span-2">
            <h2 className="text-3xl font-bold text-[#0AB0EE] mb-4">
              A Warm Welcome to Umubano Academy Lower Secondary
            </h2>
            <p className="text-gray-700 mb-6 leading-relaxed">
              Our Lower Secondary section builds strong academic foundations,
              critical thinking, independence, and character development to
              prepare learners for Senior Secondary education.
            </p>
        ...
        <div className="bg-white rounded-3xl shadow-md p-10">
          ...
          <p className="text-gray-700 leading-relaxed max-w-3xl">
            Our teaching approach recognises individual learning needs and
            supports each learner through differentiated instruction,
            mentoring, and continuous feedback to ensure academic success and
            personal growth.
          </p>
        </div>
