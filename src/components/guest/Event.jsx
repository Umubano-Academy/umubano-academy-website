...
const NextArrow = ({ onClick }) => (
  <button
    onClick={onClick}
    className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-[#7ED956] text-white p-2 rounded-full shadow-lg hover:bg-green-700 z-10"
  >
    ❯
  </button>
);
...
const PrevArrow = ({ onClick }) => (
  <button
    onClick={onClick}
    className="absolute left-2 top-1/2 transform -translate-y-1/2 bg-[#7ED956] text-white p-2 rounded-full shadow-lg hover:bg-green-700 z-10"
  >
    ❮
  </button>
);
        ...
        >
          {items.map((item, index) => (
            <motion.div
              ...
              transition={{ duration: 0.6 }}
              className="bg-white rounded-2xl shadow-lg overflow-hidden hover:-translate-y-2 transition relative"
            >
